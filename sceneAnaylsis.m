...
% # rural_turn
% # rural_turn_wall
base_dir = "/Users/jin/Desktop/Dreame/Code/frontend_analysis/Results/rural_straight/";
...
d_ts_buffer = d_ts(1);
subplot(3,1,1)
p1 = plot(d_ts-d_ts_buffer, d_ls(:,10) ./ d_ls(:,1),'Color',[0, 0.4470, 0.7410],'LineWidth',5);
subplot(3,1,2)
p1 = plot(d_ts-d_ts_buffer, d_ba(:,5) ./ d_tk(:,2),'Color',[0, 0.4470, 0.7410],'LineWidth',5);
subplot(3,1,3)
...
[d_ts,d_ls,d_tk,d_ba] = loadData(full_path2);
subplot(3,1,1)
hold on,p2 = plot(d_ts-d_ts_buffer, d_ls(:,10) ./ d_ls(:,1),'Color',[0.8500, 0.3250, 0.0980],'LineWidth',5);
subplot(3,1,2)
hold on,p2 = plot(d_ts-d_ts_buffer, d_ba(:,5) ./ d_tk(:,2),'Color',[0.8500, 0.3250, 0.0980],'LineWidth',5);
subplot(3,1,3)
hold on,p2 = plot(d_ts-d_ts_buffer, d_ba(:,3),'Color',[0.8500, 0.3250, 0.0980],'LineWidth',5);

[d_ts,d_ls,d_tk,d_ba] = loadData(full_path3);
subplot(3,1,1)
hold on,p3 = plot(d_ts-d_ts_buffer, d_ls(:,10) ./ d_ls(:,1),'Color',[0.9290, 0.6940, 0.1250],'LineWidth',5);
subplot(3,1,2)
hold on,p3 = plot(d_ts-d_ts_buffer, d_ba(:,5) ./ d_tk(:,2),'Color',[0.9290, 0.6940, 0.1250],'LineWidth',5);
subplot(3,1,3)
...
[d_ts,d_ls,d_tk,d_ba] = loadData(full_path1);
subplot(2,2,1)
hold on,p4 = plot(d_ts-d_ts_buffer, d_ls(:,10) ./ d_ls(:,1),'LineWidth',5);
subplot(2,2,2)
hold on,p4 = plot(d_ts-d_ts_buffer, d_ba(:,5) ./ d_tk(:,2),'LineWidth',5);
subplot(2,2,3)
...
[d_ts,d_ls,d_tk,d_ba] = loadData(full_path1);
subplot(2,2,1)
hold on,p5 = plot(d_ts-d_ts_buffer, d_ls(:,10) ./ d_ls(:,1),'LineWidth',5);
subplot(2,2,2)
hold on,p5 = plot(d_ts-d_ts_buffer, d_ba(:,5) ./ d_tk(:,2),'LineWidth',5);
subplot(2,2,3)
...
[d_ts,d_ls,d_tk,d_ba] = loadData(full_path1);
subplot(2,2,1)
hold on,p6 = plot(d_ts-d_ts_buffer, d_ls(:,10) ./ d_ls(:,1),'LineWidth',5);
subplot(2,2,2)
hold on,p6 = plot(d_ts-d_ts_buffer, d_ba(:,5) ./ d_tk(:,2),'LineWidth',5);
subplot(2,2,3)
...
legend([p1 p2 p3 p4 p5 p6],["1920@15Hz","960@15Hz","1920@7.5Hz","960@7.5Hz","1920@5Hz","960@5Hz"],'FontSize',20,'Location','Best')
set(gcf,'color','w');
set(gca,'color','w');
