...
clear
clc
% vins = importdata('/Users/jin/Q_Mac/data/iphone_1_25/1_25/rgbd_vio_640_.1_vins_cp.csv');

vins = importdata('/Users/jin/Q_Mac/data/iphone_1_25/1_25/rgbd_vio_highRes30Hz_vins_cp.csv');
vins(:,1) = vins(:,1)+0.03;
% vins = vins(1:5:135,:);
gt = importdata('/Users/jin/Q_Mac/data/iphone_1_25/1_25/results/gt125_gt_cp.csv'); 
...
% 
% % rpy_gt(:,2) = medfilt1(rpy_gt(:,2),15);
% % rpy_gt(:,3) = medfilt1(rpy_gt(:,3),15);
% % rpy_gt(:,4) = medfilt1(rpy_gt(:,4),15);
% 
% % rpy_gt(:,2) = smooth(rpy_gt(:,2),5);
% % rpy_gt(:,3) = smooth(rpy_gt(:,3),5);
% % rpy_gt(:,4) = smooth(rpy_gt(:,4),5);
% figure
% subplot(3,1,1)
...
vins = vins(vins(:,1)>-.1&vins(:,1)<15,:);
rpy_vins = rpy_vins(rpy_vins(:,1)>-.1&rpy_vins(:,1)<15,:);
...
set(yl, 'position', get(yl,'position')+[2.763,0,0]); 
...
set(get(gca,'YLabel'),'Rotation',0)
set(yl, 'position', get(yl,'position')+[2.763,-4,0]); 
set(gca,'FontSize',xyzsize)
xlim([3,15])
...
set(get(gca,'YLabel'),'Rotation',0)
set(yl, 'position', get(yl,'position')+[2.763,-6,0]); 
set(gca,'FontSize',xyzsize)
...
set(get(gca,'YLabel'),'Rotation',0)
set(yl, 'position', get(yl,'position')+[2.2,10,0]); 
set(gca,'FontSize',xyzsize)
xlim([3,15])
ylim([0,200])
...
set(get(gca,'YLabel'),'Rotation',0)
set(yl, 'position', get(yl,'position')+[2.2,-15,0]); 
set(gca,'FontSize',xyzsize)
xlim([3,15])
...
set(get(gca,'YLabel'),'Rotation',0)
set(yl, 'position', get(yl,'position')+[2.2,0,0]); 
set(gca,'FontSize',xyzsize)
xlim([3,15])
set(gcf,'color','w');
...
set(get(gca,'YLabel'),'Rotation',0)
set(yl, 'position', get(yl,'position')+[2.4625,-25,0]); 
set(gca,'FontSize',xyzsize)
xlim([3,15])
...
set(get(gca,'YLabel'),'Rotation',0)
set(yl, 'position', get(yl,'position')+[2.4625,-18,0]); 
set(gca,'FontSize',xyzsize)
legend("Estimate","Groundtruth",'Location','southeast')
xlim([3,15])
subplot(3,1,3)
...
set(get(gca,'YLabel'),'Rotation',0)
set(yl, 'position', get(yl,'position')+[2.4625,-5.005,0]); 
set(gca,'FontSize',xyzsize)
xlim([3,15])
...
set(get(gca,'YLabel'),'Rotation',0)
set(yl, 'position', get(yl,'position')+[2.35,-2,0]); 
set(gca,'FontSize',xyzsize)
xlim([3,15])
legend("Estimate","Groundtruth",'Location','southeast')
...
set(get(gca,'YLabel'),'Rotation',0)
set(yl, 'position', get(yl,'position')+[2.35,-3,0]); 
set(gca,'FontSize',xyzsize)
...
set(get(gca,'YLabel'),'Rotation',0)
set(yl, 'position', get(yl,'position')+[2.35,-1,0]); 
set(gca,'FontSize',xyzsize)
xlim([3,15])
